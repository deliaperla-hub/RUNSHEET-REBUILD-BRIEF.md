...
// Loaded on demand rather than imported at the top, so a build with no
// backend configured never ships the client library at all — the local-only
// product stays about half the size of the synced one.
